...
pub fn process_withdrawal (ctx: Context<Withdraw>, amount: u64) -> Result<()>{
    ...
    let shares_to_remove=(amount as f64 / bank.total_deposit_shares as f64) * bank.total_deposit_shares as f64;
